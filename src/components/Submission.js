...
class Submission extends Component {
  render() {
    ...
    return <button onClick={this.props.makeActive.bind(this, this.props.submission)} tabIndex={this.props.tabIndex} className={"submission"+(((this.props.active != null) && (this.props.active.email === email))?" active":"")}><Media>
